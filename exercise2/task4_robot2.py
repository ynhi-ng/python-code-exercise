...
which coordinates the cleaning of the space the vacuums are deployed in and taking in the consideration 
about obstructions inside the space.
-----------------------------------------------------------------------------------------------------"""
    ...
    match action:
        ...
        case "forward":
            ...
            # if step forward meet the cat, robot turn right
                ...
                #check cat new location whether it meet the wall or out of check_boundary, if not update the new location of the cat
...
def perform_cleaning(instructions:str, vacuum:list, log:str)-> None:
    ...
    Parameter
        ...
        vacuum : list[int|int|str]: containing the vacuum's position and direction its facing
        log : str : log file use for write the action robot actually perform after receive instruction
    """
